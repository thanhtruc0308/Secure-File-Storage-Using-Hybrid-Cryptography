...
def Algo1(key):
	...
	for line in target_file:
		secret_data = secret_data + line.decode('utf-8')
	data = f.decrypt(secret_data.encode('utf-8'))
	target_file.close()
	return data
...
def decrypter():
	...
	for line in public_key:
		key_1 = key_1 + line.decode('utf-8')
	public_key.close()
	secret_information = Algo1(key_1)
	list_information = secret_information.split(':::::'.encode('utf-8'))
