...
def Algo1_extented(filename, key1, key2):
	...
	raw = ""
	for line in file:
		raw = raw + line.decode("utf-8")
	secret_data = f.encrypt(raw.encode("utf-8"))
	target_file.write(secret_data)
	file.close()
	target_file.close()
...
def encrypter():
	...
	secret_information = (key_1_1)+":::::".encode("utf-8")+(key_1_2)+":::::".encode("utf-8")+(key_2)+":::::".encode("utf-8")+(key_3)+":::::".encode("utf-8")+(key_4)+":::::".encode("utf-8")+(nonce12)+":::::".encode("utf-8")+(nonce13)
